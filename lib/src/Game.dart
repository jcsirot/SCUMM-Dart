...
class Game {
  ...
  Game(String name) {
    this.name = name;
    this.assetManager = new AssetManager("game/monkey/");
  }

  load(String name, Function callback) {
    assetManager.queue("${name}.000");
    assetManager.queue("${name}.001");
    assetManager.downloadAll(callback);
  }
